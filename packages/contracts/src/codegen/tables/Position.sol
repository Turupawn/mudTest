...
library Position {
   ...
   * @notice Get x.
   */
  function _getX() internal view returns (int32 x) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set x.
   */
  function _setX(int32 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get y.
   */
  function _getY() internal view returns (int32 y) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set y.
   */
  function _setY(int32 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get the full data.
   */
  function _get() internal view returns (PositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(int32 x, int32 y) internal {
    bytes memory _staticData = encodeStatic(x, y);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(PositionData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y);
